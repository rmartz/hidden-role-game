...
- **The directory index is `index.md`** (the OKF canonical index filename, not `README.md`). The top-level index is `docs/index.md`; a subdirectory that needs its own index uses `<dir>/index.md`.
