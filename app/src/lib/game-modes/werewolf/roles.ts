...
export const WEREWOLF_ROLES: Record<WerewolfRole, WerewolfRoleDefinition> = {
  ...
  [WerewolfRole.LoneWolf]: {
    ...
    description:
      "The Lone Wolf wakes with the Werewolves each night and participates in their hunt. However, the Lone Wolf wins alone — if all remaining Bad players are Lone Wolves and they outnumber or match the non-Bad players, the Lone Wolf wins.",
    team: Team.Bad,
    isWerewolf: true,
    wakesAtNight: WakesAtNight.EveryNight,
    targetCategory: TargetCategory.None,
