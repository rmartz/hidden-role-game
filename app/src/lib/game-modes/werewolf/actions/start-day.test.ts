    ...
    describe("Old Man timer", () => {
      ...
      it("Wolf Cub counts toward werewolf total for timer", () => {
        ...
        const game3 = makePlayingGame(makeNightState({ turn: 3 }), {
          ...
          players: [
            { id: "p1", name: "W1", sessionId: "s1", visiblePlayers: [] },
            { id: "p6", name: "WC", sessionId: "s6", visiblePlayers: [] },
            { id: "p2", name: "OM", sessionId: "s2", visiblePlayers: [] },
            { id: "p3", name: "V1", sessionId: "s3", visiblePlayers: [] },
            { id: "p4", name: "V2", sessionId: "s4", visiblePlayers: [] },
            { id: "p5", name: "V3", sessionId: "s5", visiblePlayers: [] },
          ],
        ...
        const ts3 = (game3.status as { turnState: WerewolfTurnState })
          .turnState;
        ...
        const ts4 = (game4.status as { turnState: WerewolfTurnState })
          .turnState;
