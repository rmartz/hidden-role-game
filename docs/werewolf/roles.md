...
5. The Witch acts **third-to-last** (before Altruist and Insomniac), after all other roles, so she can see current attacks before deciding.
6. The Altruist acts **second-to-last**, after the Witch, so it can intercept attacks (including Witch attacks) on its target.
