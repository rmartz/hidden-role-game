...
| Altruist      | `werewolf-altruist`      | Good    | Every Night               | Special (intercept)    | Acts after the Witch (second-to-last before Insomniac); intercepts an attack on the target and dies in their place                                                                                                                                                                                                                                                                       |
...
1. `EvilKilling` (Bad — Attack):
   - Werewolf (group phase, first in EvilKilling; includes Wolf Cub)
...
Within a category, the order is arbitrary. After all category-ordered roles, the Witch, Altruist, and Insomniac always act last in that order.
...
5. The Witch acts after all category-ordered roles and before the Altruist (and before Insomniac if present), so she can see current attacks before deciding.
6. The Altruist acts after the Witch and before the Insomniac (if present), so it can intercept attacks (including Witch attacks) on its target.
...
8. The Insomniac always acts **last**, after all other roles including the Altruist, so it can observe the complete set of night actions.
