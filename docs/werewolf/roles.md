...
| Tavern Keeper | `werewolf-tavern-keeper` | Good    | Every Night               | Special (role-block)   | Wakes at their normal position in the night order; chooses one player to serve too many drinks. At day start, that player's night action is retroactively undone as if they never acted — they appear in the Night Summary as "awakes with a hangover". Investigative roles are unaffected. Unique; `preventSelfTarget`.                                                                  |
